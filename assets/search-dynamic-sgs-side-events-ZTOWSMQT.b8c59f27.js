...
Alg F D F' D L2 F R' F' D' B2 U'`)}async function i(){const L=a("megaminx",{allMoves:!0,addRotations:!0}),l=new n(L.getKPuzzleDefinition(!0),{experimentalPGNotation:new e(L,L.getOrbitsDef(!0))});return l.definition.name="megaminx",l}var A=null;async function c(){return A??(A=i())}var F=null;async function b(){return F??(F=o())}async function o(){return R(await c(),`SubgroupSizes 12 5 60 58 60 56 54 57 52 50 54 48 46 51 44 42 48 40 45 38 36 42 34 32 39 30 36 28 26 33 24 30 22 20 27 18 24 16 14 21 12 18 10 15 8 6 2 12 9 3
...
Alg U BR2' U R' U2' L U2 R U' BR2 U' L'`)}var B=null;async function s(){return B??(B=y())}async function h(){return{ordering:(await s()).ordering.slice(2)}}async function y(){return R(await r.pyraminx.kpuzzle(),`SubgroupSizes 12 9 12 3 10 3 8 6 2 3 3 3 3
...
Alg u
Alg u'`)}async function z(){const L=a("skewb",{allMoves:!0,addRotations:!0});return new n(L.getKPuzzleDefinition(!0),{experimentalPGNotation:new e(L,L.getOrbitsDef(!0))})}var D=null;async function f(){return D??(D=z())}var U=null;async function d(){return U??(U=m())}async function w(){return{ordering:(await d()).ordering.slice(1)}}async function m(){return R(await f(),`SubgroupSizes 24 6 5 12 9 3 4 9 3 3
...
Alg U R' U' L B R' B' R
Alg R' U' R U B' U' B L`)}export{x as cachedData222,c as cachedMegaminxKPuzzleWithoutMO,b as cachedSGSDataMegaminx,s as sgsDataPyraminx,h as sgsDataPyraminxFixedOrientation,d as sgsDataSkewb,w as sgsDataSkewbFixedCorner,f as skewbKPuzzleWithoutMOCached};
